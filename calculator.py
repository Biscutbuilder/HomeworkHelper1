...
color_light_gray = "#505049"
color_black = "#1C1C1C"
color_light_blue = "#0793A5"
color_blue = "#04517E"
...
for row in range(row_count):
    for column in range(column_count):
        ...
        if value in top_symbols:
            button.config(foreground=color_black, background=color_light_blue)
        elif value in right_symbols:
            button.config(foreground=color_white, background=color_blue)
        else:
            button.config(foreground=color_white, background=color_light_gray)
